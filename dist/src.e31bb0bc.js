...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"fetch-wrapper.js":[function(require,module,exports) {
"use strict";
...
var FetchWrapper = /*#__PURE__*/function () {
  ...
  _createClass(FetchWrapper, [{
    ...
    key: "_send",
    value: function _send(method, endpoint, body) {
...
exports.saveToLocalStorage = exports.getTime = exports.getDate = void 0;

var getDate = function getDate(word) {
...
var saveToLocalStorage = function saveToLocalStorage(heatIndex) {
  var heatIndexes;
...
var _fetchWrapper = _interopRequireDefault(require("./fetch-wrapper"));
...
var API = new _fetchWrapper.default("https://www.metaweather.com/api");
var tabs = document.querySelectorAll(".tab");
var tableBody = document.querySelector(".table tbody");
var form = document.querySelector("#heat-index-form");
var temperature = document.querySelector("#temperature");
var humidity = document.querySelector("#humidity");
var degreesEntry = document.querySelector("#degrees");
var degreesResult = document.querySelector("#degrees-result");
var heatIndexResult = document.querySelector("#heat-index");
var errorMessage = document.querySelector(".error-message");
var recentResults = document.querySelector(".recent-results");
var spinner = document.querySelector(".spinner-border");
var dateInput = document.querySelector("#weather-date");
...
tabs.forEach(function (tab) {
  tab.addEventListener("click", function (event) {
    ...
    var content = document.querySelector(event.currentTarget.dataset.content);
    var previousShow = document.querySelector(".tab-content.show");
...
var getDataFromWeatherAPI = function getDataFromWeatherAPI() {
  ...
  API.get("/location/44418/".concat(date())).then(function (data) {
    ...
    data === null || data === void 0 ? void 0 : data.forEach(function (entry) {
      tableBody.insertAdjacentHTML("beforeend", "\n            <tr>\n                <td>".concat((0, _helpers.getDate)(entry.created), "</td>\n                <td>").concat((0, _helpers.getTime)(entry.created), "</td>\n                <td>").concat(entry.weather_state_name, "</td>\n                <td>").concat(entry.the_temp.toFixed(1), "</td>\n                <td>").concat(entry.air_pressure.toFixed(1), "</td>\n                <td>").concat(entry.humidity.toFixed(1), "</td>\n                <td>").concat(entry.wind_speed.toFixed(1), "</td>\n            </tr>"));
    });
...
var renderChart = function renderChart() {
  ...
  API.get("/location/44418/".concat(date())).then(function (data) {
    ...
    var dateTime = data.reverse().map(function (entry) {
      return (0, _helpers.getDate)(entry.created) + " " + (0, _helpers.getTime)(entry.created);
    }); // Chart creating
...
var calculateTemperature = function calculateTemperature() {
  var result = "";
...
var calculateHeatIndex = function calculateHeatIndex() {
  var T = calculateTemperature();
  var rh = humidity.value;
  var index = -42.379 + 2.04901523 * T + 10.14333127 * rh - 0.22475541 * T * rh - 6.83783 * Math.pow(10, -3) * Math.pow(T, 2) - 5.481717 * Math.pow(10, -2) * Math.pow(rh, 2) + 1.22874 * Math.pow(10, -3) * Math.pow(T, 2) * rh + 8.5282 * Math.pow(10, -4) * T * Math.pow(rh, 2) - 1.99 * Math.pow(10, -6) * Math.pow(T, 2) * Math.pow(rh, 2);
...
form.addEventListener("submit", function (event) {
  ...
  var heatIndex = calculateHeatIndex().toFixed(1);
  var heatIndexToStorage = heatIndex + " " + degreesResult.value;
  recentResults.insertAdjacentHTML("afterbegin", "\n        <li class=\"recent-result\">".concat(heatIndexToStorage, "</li>\n    "));

  if (recentResults.getElementsByTagName('li').length > 5) {
    recentResults.lastElementChild.remove();
  }

  (0, _helpers.saveToLocalStorage)(heatIndexToStorage);
  heatIndexResult.textContent = heatIndex;
}); // Display history of 5 results of Heat Index from local storage

var displayHeatIndexes = function displayHeatIndexes() {
  var heatIndexes;
  ...
  var lastIndexes = heatIndexes.slice(Math.max(heatIndexes.length - 5, 0));
  lastIndexes.reverse().forEach(function (index) {
    recentResults.insertAdjacentHTML("beforeend", "\n        <li class=\"recent-result\">".concat(index, "</li>\n        "));
  });
};

displayHeatIndexes();
render();
},{"./styles/main.scss":"styles/main.scss","./fetch-wrapper":"fetch-wrapper.js","../node_modules/chart.js/dist/chart":"../node_modules/chart.js/dist/chart.js","./helpers":"helpers.js","flatpickr":"../node_modules/flatpickr/dist/esm/index.js","../node_modules/flatpickr/dist/flatpickr.min.css":"../node_modules/flatpickr/dist/flatpickr.min.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
